...
$sql = mysqli_query($con, 'INSERT INTO voters(firstname,lastname,username,Aadhar_no,Voter_id,District,Taluk)
         VALUES("'.$_POST['firstname'].'","'.$_POST['lastname'].'","'.$_POST['username'].'","'.$_POST['Aadhar_no'].'","'.$_POST['Voter_id'].'","'.$_POST['District'].'","'.$_POST['Taluk'].'")');

$sql = mysqli_query($con, 'INSERT INTO languages(fullname)   VALUES("'.$_POST['fullname'].'")');
